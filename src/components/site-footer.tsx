...
export function SiteFooter() {
  return (
    <footer className="border-t border-white/10 bg-slate-950">
      <div className="mx-auto grid max-w-7xl gap-8 px-6 py-12 lg:grid-cols-[1.5fr_1fr] lg:px-10">
      ...
      <div className="border-t border-white/10 px-6 py-4 text-center text-xs uppercase tracking-[0.2em] text-slate-500 lg:px-10">
