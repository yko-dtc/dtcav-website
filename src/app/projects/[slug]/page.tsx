      ...
      <div className="grid gap-10 lg:items-start lg:grid-cols-[0.9fr_1.1fr]">
        <div className="space-y-7">
          <Reveal>
            ...
            <h1 className="page-title mt-5 leading-[1.06]">{project.title}</h1>
            <p className="mt-6 text-base leading-7 text-slate-300 sm:text-lg sm:leading-8">{project.summary}</p>
          </Reveal>
          ...
          <Reveal className="panel-padding-sm rounded-[2rem] border border-white/10 bg-white/[0.03] text-sm leading-7 text-slate-300 sm:text-base sm:leading-8" delay={0.15}>
            {project.overview}
          </Reveal>
        </div>
